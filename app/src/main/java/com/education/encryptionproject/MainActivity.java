package com.education.encryptionproject;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button buttonMd5;
    @InjectView(R.id.button_aes_encrypt)
    Button buttonEncrypt;
    @InjectView(R.id.button_aes_decrypt)
    ...
    @OnClick({R.id.button_md5, R.id.button_aes_encrypt, R.id.button_aes_decrypt, R.id.button_base64_encrypt, R.id.button_base64_decrypt, R.id.button_rsa_encrypt, R.id.button_rsa_decrypt})
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.button_md5:
                ...
                break;
            case R.id.button_aes_encrypt:
                String aesEncrypt = EncryptUtils.aesEncrypt(edittextPassword.getText().toString());
                textviewEncrypt.setText(aesEncrypt);
                break;
            case R.id.button_aes_decrypt:
                String aesContent = EncryptUtils.aesDecrypt(textviewEncrypt.getText().toString());
                textviewEncrypt.setText(aesContent);
                break;
            ...
            case R.id.button_rsa_encrypt:
                String rsaEncrypt = EncryptUtils.rsaEncrypt(edittextPassword.getText().toString());
                textviewEncrypt.setText(rsaEncrypt);
                break;
            case R.id.button_rsa_decrypt:
                String rsaContent = EncryptUtils.rsaDecrypt(textviewEncrypt.getText().toString());
                textviewEncrypt.setText(rsaContent);
                break;
        }
    }
}
